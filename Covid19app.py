...
df = pd.read_csv(r'https://raw.githubusercontent.com/nafalii-7/Web_App/main/covid19_data.csv', encoding='ISO-8859-1',thousands='.', decimal=',', engine='python')
df.head()  
...
if  votre_choix == "suivi epideomologique":
    ...
    st.markdown('__voici un tableau regroupant les donnés sur la compagne de vaccination au maroc__')
    st.write(df)
