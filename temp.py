...
df=pd.read_csv('https://github.com/nafalii-7/Web_App/blob/main/covid19_data.csv', index_col=0)
#df = pd.read_csv('https://github.com/nafalii-7/Web_App/blob/main/covid19_data.csv', encoding='ISO-8859-1',thousands='.', decimal=',', engine='python')
df.head()  
